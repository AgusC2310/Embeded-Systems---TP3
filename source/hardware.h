...
#define DEBUG_PIN12C 12

#define SETB_ADDRS (0x400FF044u)
#define SETB_PTR ((uint32_t *)SETB_ADDRS)
#define SETB_VAL (1<<DEBUG_PIN)
#define CLRB_ADDRS (0x400FF048u)
#define CLRB_PTR ((uint32_t *)CLRB_ADDRS)
#define CLRB_VAL (1<<DEBUG_PIN)
#define DEBUG_TP_SET *(SETB_PTR) = SETB_VAL
#define DEBUG_TP_CLR	*(CLRB_PTR) = CLRB_VAL

#define SETC_ADDRS (0x400FF084u)
#define SETC_PTR ((uint32_t *)SETC_ADDRS)
#define SETC_VAL (1<<DEBUG_PIN12C)
#define CLRC_ADDRS (0x400FF088u)
#define CLRC_PTR ((uint32_t *)CLRC_ADDRS)
#define CLRC_VAL (1<<DEBUG_PIN12C)
#define DEBUG_TP12C_SET *(SETC_PTR) = SETC_VAL
#define DEBUG_TP12C_CLR	*(CLRC_PTR) = CLRC_VAL
